...
--
-- Host: localhost    Database: banbajio
-- ------------------------------------------------------
...
CREATE TABLE `producto` (
  ...
  `id_tipo_producto` bigint DEFAULT NULL,
...
CREATE TABLE `producto_proveedor` (
  `id_producto_proveedor` bigint NOT NULL AUTO_INCREMENT,
  `id_producto` bigint NOT NULL,
  `id_proveedor` bigint NOT NULL,
  `clave_proveedor` varchar(255) NOT NULL,
...
-- Dump completed on 2026-01-13  1:00:57
